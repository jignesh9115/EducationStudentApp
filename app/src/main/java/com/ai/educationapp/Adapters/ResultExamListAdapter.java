...
import com.ai.educationapp.ViewResultDetails;
import com.ai.educationapp.databinding.EntityExamListBinding;

import java.util.ArrayList;

public class ResultExamListAdapter extends BaseAdapter {
    ...
    public ResultExamListAdapter(ArrayList<ExamTypePOJO> examTypePOJOArrayList, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        binding.cardExamList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, ViewResultDetails.class);
