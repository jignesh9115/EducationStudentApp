...
public class ExamDetailsPOJO {
    ...
    String exam_title,exam_standard,exam_date,subject_title,exam_total_marks,exam_type_title,exam_id;

    public ExamDetailsPOJO(String exam_title, String exam_standard, String exam_date, String subject_title, String exam_total_marks, String exam_type_title, String exam_id) {
